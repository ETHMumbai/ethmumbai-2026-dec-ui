      ...
      <div className="flex gap-4 md:gap-20 pl-14 flex-wrap mb-12 max-w-[350px] sm:max-w-full mx-auto">
        {speakers.map((speaker, index) => (
          ...
          >
            ...
            {/* Speaker Info */}
            <h3
              className="text-[16px] font-normal leading-6 tracking-[-0.31px] text-white text-center mb-1"
              style={{ fontFamily: "Inter" }}
            >
              {speaker.name}
            </h3>
            <p
              className="text-[14px] font-normal leading-5 tracking-[-0.015px] text-white text-center"
              style={{ fontFamily: "Inter" }}
            >
              {speaker.company}
            </p>
